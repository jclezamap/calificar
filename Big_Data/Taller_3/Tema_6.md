...
1. **Exploración de Series Temporales:** Cargue el archivo `Actividad2.xlsx` y, utilizando el método `.loc`, extraiga el precio de cierre de la acción **AAPL** para la fecha exacta de **'2024-01-18'**.   
